  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2 mt-4">
        ...
        <p className="bg-[#242424] cursor-pointer  px-4 py-1 rounded-2xl text-white">Music</p>
        <p className="bg-[#242424] cursor-pointer  px-4 py-1 rounded-2xl text-white">Podcasts</p>
      </div>
    </>
  );
};
